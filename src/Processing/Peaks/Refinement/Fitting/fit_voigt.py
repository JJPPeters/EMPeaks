...
def do_fitting_voigt(data, points, fit_r=10, lim=1, frac_change=0, fit_method='leastsq'):
    image = normalise_copy(data)

    initial_params = estimate_voigt_parameters(image, points, fit_r)
...
def estimate_voigt_parameter(image_region, point, r):
...
def estimate_voigt_parameters(full_image, points, r):
    ...
    for point in points:
        ...
        param_list.append(estimate_voigt_parameter(image_region, point, r))
