...
def do_fitting_pearson(data, points, fit_r=10, lim=1, frac_change=0, fit_method='leastsq'):
    image = normalise_copy(data)

    initial_params = estimate_pearson_parameters(image, points, fit_r)
...
def estimate_pearson_parameter(image_region, point, r):
...
def estimate_pearson_parameters(full_image, points, r):
    ...
    for point in points:
        ...
        param_list.append(estimate_pearson_parameter(image_region, point, r))
