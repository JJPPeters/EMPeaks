...
def do_fitting_gauss(data, points, fit_r=10, lim=1, frac_change=0, fit_method='leastsq'):
    ...
    initial_params = estimate_gauss_parameters(image, points, fit_r)
...
def estimate_gauss_parameter(image_region, point, r):
...
def estimate_gauss_parameters(full_image, points, r):
    ...
    for point in points:
        ...
        param_list.append(estimate_gauss_parameter(image_region, point, r))
